...
// Main Coache Schema
const CoacheUnverified2Schema = new mongoose.Schema({
...
// Export Model
const CoachUnverified2 = mongoose.model(
  "CoachUnverified2",
  CoacheUnverified2Schema
);
// export default Coache; // For ES6
// or
module.exports = CoachUnverified2; // For CommonJS
